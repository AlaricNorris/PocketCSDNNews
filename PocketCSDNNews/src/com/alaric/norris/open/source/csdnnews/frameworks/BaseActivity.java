...
public class BaseActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ActivityCollectorTool.addActivity(this);// Activity��ʼ��ʱ������AcitivityCollector��List��
	}
	...
	protected void onDestroy() {
		super.onDestroy();
		ActivityCollectorTool.removeActivity(this);// Activity�����ʱ����AcitivityCollector��List���Ƴ�
	}
